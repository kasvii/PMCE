...
class FeatureDataset(Dataset):
    ...
    def get_sequence(self, start_index, end_index):
        if start_index != end_index:
            return self.feature_list[start_index:end_index+1], self.joint2d_list[start_index:end_index+1]
        else:
            return self.feature_list[start_index][None,:].expand(self.seq_len,-1), self.joint2d_list[start_index][None,:].expand(self.seq_len,-1,-1)
